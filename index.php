...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="">
        <div id="main">
            <nav class="w3-sidenav w3-collapse w3-animate-left sidebarwidth w3-border-right" id="mySidenav">
                <div href="#" class="w3-container w3-center w3-padding w3-green" id="banner">
