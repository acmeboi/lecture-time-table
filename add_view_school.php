	...
	<div class="w3-col l3 w3-border-green w3-rightbar">
		<h3 class="w3-center">New School</h3>
			<div class="w3-container alert-danger w3-padding w3-margin w3-round w3-hide" id="error">Record Exist
				...
				<br /><br />
				<input type="submit" class="w3-green w3-round w3-btn" value="Add" id="btn_school" />
				<input type="reset" value="Reset" class="w3-btn w3-round w3-red" id="btn_school_cancel" />
			</form>
	</div>

	<div class="w3-col w3-margin l8 dataTable_wrapper" id="department_display" style="max-height:10%; height:450px; overflow:scroll;">
    </div>
